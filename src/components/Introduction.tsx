...
function FeatureCard({
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute -top-20 -left-20 w-40 h-40 bg-purple-400/10 rounded-full blur-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-700"
        style={{ transitionDelay: "150ms" }}
      ></div>

      <div className="flex justify-center mb-6 relative">
        <div
          className={`p-4 rounded-full bg-white/5 transition-all duration-500 ${
            isActive
              ? "neon-border bg-gradient-to-br from-blue-500/20 to-purple-500/20"
              : ""
          }`}
        >
          {icon}
      ...
      <h3
        className={`text-xl font-semibold mb-4 text-center transition-all duration-500 ${
